...
function Layout({ children }) {
  return (
    <div className="">
      <header>
        <div className="header-top bg-info-content p-2">
          <div className="w-3/4 mx-auto flex gap-6 justify-end">
          <Link className="text-[#c7c9d1] hover:underline">Sign in / Guest</Link>
          <Link className="text-[#c7c9d1] hover:underline">Create Account</Link>
          </div>
        </div>
        <div className="header-bottom bg-primary-content">
          <div className="navbar w-3/4 mx-auto">
            <div className="navbar-start">
              <div className="dropdown">
                ...
                <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] bg-primary-content p-2 shadow bg-base-100 rounded-box w-52">
              ...
              <Link to="/" className="btn btn-primary hidden text-3xl lg:flex">C</Link>
            </div>
